...
RUN elasticsearch-plugin install -b https://github.com/vvanholl/elasticsearch-prometheus-exporter/releases/download/5.4.1.0/elasticsearch-prometheus-exporter-5.4.2.0.zip
RUN \
